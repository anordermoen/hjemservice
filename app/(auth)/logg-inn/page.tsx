      ...
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <p className="text-muted-foreground">
            Velkommen tilbake til HjemService
          </p>
        </CardHeader>
        <CardContent>
          ...
          <div className="mt-4 text-center text-sm">
            <span className="text-muted-foreground">Er du fagperson? </span>
            <Link href="/bli-leverandor" className="text-primary hover:underline">
              Bli leverandør
            </Link>
          </div>
        </CardContent>
